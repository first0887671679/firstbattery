...
async function main() {
  const hashedPassword = await bcrypt.hash('__ADMIN_PASSWORD__', 10)
  ...
  const homePage = existingHome || await (prisma as any).page.create({
    data: {
      ...
      title: 'หน้าแรก',
      order: 0,
      seoTitle: '__BRAND_NAME__ บริการแบตเตอรี่รถยนต์ 24 ชั่วโมง',
      seoDescription: 'บริการเปลี่ยนแบตเตอรี่รถยนต์นอกสถานที่ 24 ชั่วโมง __SERVICE_AREA__',
        ...
        slides: [
          {
            ...
            description: 'เปลี่ยนแบตถึงที่รวดเร็วทันใจ __SERVICE_AREA__',
    ...
    // 7: คำถามที่พบบ่อย (ข้อมูลเต็มจาก FaqItem model เดิม)
    {
      ...
      content: JSON.stringify({
        items: [
          ...
          { question: 'ราคาบริการเท่าไหร่?', answer: 'ราคาขึ้นอยู่กับรุ่นรถและประเภทงานบริการ สามารถแอดไลน์ __LINE_ID__ หรือโทรสอบถามราคาได้ฟรี ไม่มีค่าใช้จ่ายในการประเมินราคา' },
        ],
      }),
      order: 7,
    },
  ...
  const batteryPage = existingBattery || await (prisma as any).page.create({
    data: {
      ...
      order: 1,
      seoTitle: 'เปลี่ยนแบตเตอรี่รถยนต์นอกสถานที่ 24 ชม. | __BRAND_NAME__',
  ...
  const tireRepairPage = existingTire || await (prisma as any).page.create({
    data: {
      ...
      order: 2,
      seoTitle: 'ปะยางนอกสถานที่ 24 ชม. __SERVICE_AREA__ ถึงไว ด่วนทันใจ',
      seoDescription: 'ยางแตก ยางรั่ว โทรเรียกเรา! บริการปะยางนอกสถานที่ด่วน __SERVICE_AREA__ ช่างชำนาญงาน พร้อมให้บริการและแก้ปัญหาทันที',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'ด่วนทันใจ __SERVICE_AREA__',
  ...
  const batteryReplacementPage = existingBattReplacement || await (prisma as any).page.create({
    data: {
      ...
      order: 3,
      seoTitle: 'ร้านแบตเตอรี่รถยนต์ นอกสถานที่ __SERVICE_AREA__ เปลี่ยนแบตด่วน',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'เปลี่ยนแบตด่วน 24 ชม. __SERVICE_AREA__',
  ...
  const alternatorPage = existingAlternator || await (prisma as any).page.create({
    data: {
      ...
      order: 4,
      seoTitle: 'ซ่อมเปลี่ยนไดชาร์จ ไดสตาร์ท นอกสถานที่ __SERVICE_AREA__',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'ด่วน __SERVICE_AREA__',
  ...
  const polishingPage = existingPolishing || await (prisma as any).page.create({
    data: {
      ...
      order: 5,
      seoTitle: 'รับขัดสีรถยนต์ ขัดไฟหน้านอกสถานที่ ถึงบ้านคุณ __SERVICE_AREA__',
      seoDescription: 'บริการขัดสีรถลบรอย ขัดไฟหน้าเหลืองให้ใสปิ๊ง นอกสถานที่ ไม่ต้องทิ้งรถไว้ที่ร้าน สะดวกสบาย บริการถึงบ้าน __SERVICE_AREA__',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'นอกสถานที่ ถึงบ้าน __SERVICE_AREA__',
